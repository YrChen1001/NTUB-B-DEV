...
# 安裝包根目錄 = 此腳本所在資料夾的上一層（與 setup-and-run.bat 同層）
$scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$baseDir   = Split-Path -Parent $scriptDir

$repoUrl   = "https://github.com/Yrchen1001/NTUB-B-DEV.git"
$targetDir = Join-Path $baseDir "NTUB-B-DEV"

Write-Host "=== NTUB-B 一鍵安裝與啟動 (Windows, 安裝包版) ===`n"
Write-Host "安裝路徑：$targetDir`n"
